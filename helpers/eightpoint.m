...
%input:
%  im1 and im2 
%  optional: pts1, pts2 - matching points previously selected in both images
%returns estimated F matrix 
%also returns points clicked in both images


function [F, pts1, pts2] = eightpoint(im, im2, pts1, pts2)
